export default function Sidenav() {
  return (
    <div className="sidenav lg:col-span-1 hidden lg:block  px-3 box-content">
      <div className="max-w-full grid grid-flow-row gap-7 lg:w-4/5 xl:w-full mx-auto">
        ...
        <div>
          ...
          <aside className="flex items-center gap-3 text-[10px] font-bold">
            <div className="border border-wine-900 rounded-full px-2  bg-newgray-100 font-bold ">3000 NGN</div> 
            <div className="border border-wine-900 rounded-full px-2  ">20,000 NGN</div>
          </aside>
        </div>
      </div>
    </div>
