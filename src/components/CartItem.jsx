...
export default function CartItem({ item,handleDeleteCart }) {
  
  return (
    <li className="flex justify-between items-center">
      <div className="flex items-center my-5 gap-4 border-b border-gray-100 py-3 ">
      ...
      <Button type="h-10" onclick={()=>handleDeleteCart(item)}>remove</Button>
    </li>
  );
}
